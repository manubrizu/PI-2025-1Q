...
/*
** Agrega un versículo a la Biblia. Si ya estaba ese número de
versículo en ese número de libro, no lo agrega ni modifica y retorna
0. Si lo agregó retorna 1
** bookNbr: número de libro
** verseNbr: número de versículo
*/
int addVerse(bibleADT bible, size_t bookNbr, size_t verseNbr, const
char * verse);
